...
model = dict(
    ...
    head=dict(
        ...
        motion_plan_head=dict(
            type='V15MotionPlanningHead', # choose anchor query based on cmd
            fut_ts=fut_ts,
            fut_mode=fut_mode,
            ego_fut_ts=ego_fut_ts,
            ego_fut_mode=ego_fut_mode,
            if_init_timemlp=False,
            motion_anchor=f'data/kmeans/kmeans_motion_6.npy',
            plan_anchor=f'data/kmeans/kmeans_plan_6.npy',
            embed_dims=embed_dims,
            ...
            diff_refine_layer=dict(
                type="V4_3DiffMotionPlanningRefinementModule",
                embed_dims=embed_dims,
                fut_ts=fut_ts,
                fut_mode=fut_mode,
                ego_fut_ts=ego_fut_ts,
